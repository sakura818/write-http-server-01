 ...
 */
public class BoardDynamicHttpResponseStatusLineBuilder {// TODO:Staticと処理同じだから一緒にしたほうがいいのかもしれない(違うかもしれない)　今回たまたま処理を一緒にできるだけで他の動的アプリケーションの場合は一緒にできないかもしれないから処理を継承させずに独立させておくほうが無難?かもしれない
