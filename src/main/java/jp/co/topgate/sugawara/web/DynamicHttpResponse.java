...
public abstract class DynamicHttpResponse {  //TODO: 抽象クラスを有効に使えていない
    ...
    public abstract byte[] createDynamicHttpResponseContent(File file, int statusCode, HttpRequest httpRequest, Map<String, String> responseBody, String rawPassword) throws IOException;
